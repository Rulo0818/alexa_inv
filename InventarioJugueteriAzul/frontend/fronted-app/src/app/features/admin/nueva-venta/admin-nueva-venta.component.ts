...
@Component({
  selector: 'app-admin-nueva-venta',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './admin-nueva-venta.component.html',
  styleUrl: './admin-nueva-venta.component.css',
})
export class AdminNuevaVentaComponent implements OnInit {
